        ...
        (function($) {
            ...
            const initialMaxYear = $('#ex3').data('slider-max');
                ...
                if(vertical_filter_model!=""){
                    ...
                    let auction = JSON.parse(localStorage.getItem('brand_new_auction'));
             ...
             $('#vertical_brand').on('change',function(e){
                e.preventDefault();  
                localStorage.removeItem('brand_new_auction');
            ...
            let distinctData = JSON.parse(localStorage.getItem('brand_new_auction'));
            $("#vertical_filter_model").on('change', function(e) {
                    ...
                    if($("#vertical_filter_model").val() !=""){
                            ...
                            success: function(data) {
                                ...
                                localStorage.setItem('brand_new_auction', JSON.stringify(data.response));  
                            }
                            });
                    }  else {
                        localStorage.setItem('brand_new_auction', JSON.stringify({}));
                    }
                    let auction = JSON.parse(localStorage.getItem('brand_new_auction'));
                    $('#search_form')[0].reset(); 
