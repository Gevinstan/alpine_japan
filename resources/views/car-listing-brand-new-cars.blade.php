        ...
        <div class="container px-2 px-sm-3 px-lg-5">
            <nav aria-label="breadcrumb" class="">
                <ol class="px-3 breadcrumb breadcrumb-list">
                    ...
                    <li class="breadcrumb-item breadcrumb-link" aria-current="page">{{ __('translate.Fixed Car Marketplace Brand New Cars') }}</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-lg-3">
                                                                ...
                                                                <span class="form-check d-flex flex-column align-items-start list-dropdown" id="headingOne">
                                                                    <div class="gap-2 accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{$index}}" aria-expanded="true" aria-controls="collapseOne">
                                                                        <input name="brand[]" class="form-check-input brand-search" type="checkbox"
                                                                             value="{{ $brand->slug }}" style="display:none;"
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-md-6" data-aos="fade-u p"
                                        ...
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                                <div class="">
                                                <a href="{{ route('fixed-car-marketplace-details', ['category' => 'fixed-car-marketplace', 'id' => $car['id']]) }}" data-bs-toggle="tooltip">
                                            ...
                                            <div class="brand-car-inner position-relative">
                                                ...
                                                <a href="{{ route('fixed-car-marketplace-details', ['category' => 'fixed-car-marketplace', 'id' => $car['id']]) }}"data-bs-toggle="tooltip" title="FORWARD">
    ...
    <script>
        ...
        (function($) {
            ...
            if($("#vertical_brand").val()!=""){
                ...
                $("#vertical_filter_model").empty().append('<option value="">Select Model</option>');
