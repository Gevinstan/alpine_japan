...
<body>
    ...
    @endif
                ...
                <div class="col-lg-8 col-p-0">
                    <div class="header-right-item">
                        ...
                        <div class="header-right-social-media-btn">
                            ...
                            <span style="background-color:white; padding:3px; border-radius:50%"><i class="bi bi-youtube"></i></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav class="menu-bg ">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-p-0" style="background-color: white">
                        <div class="nav-main" style="padding:0px;">
                            <div class="nav-left">
                                <div class="logo">
                                    <a href="{{ route('home') }}">
                                        @if (Route::is('home'))
                                            @if (Session::get('selected_theme') == 'theme_two')
                                                <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="width:60px;height:60px;margin-top: -4px ">
                                            @elseif (Session::get('selected_theme') == 'theme_three')
                                            <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="width:60px;height:60px; ">
                                            @else
                                                <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="width:60px;height:60px; ">
                                            @endif
                                        @else
                                ...
                                <div class="menu">
                                    <ul >
                                        @if ($setting->selected_theme == 'all_theme')
                                            <li><a style="color: black !important" href="{{ route('home') }}">{{ __('translate.Home') }}</a>
                                        ...
                                        @else
                                         <li><a style="color: black !important" href="{{ route('home') }}">{{ __('translate.Home') }}</a></li>
                                        @endif
                            ...
                            <div class="nav-btn">
                                ...
                                @if (Route::is('home'))
                                    ...
                                    @elseif (Session::get('selected_theme') == 'theme_two')
                                        <a href="{{ route('user.select-car-purpose') }}" class="thm-btn-thr">{{ __('LOGIN') }}</a>
                                    @elseif (Session::get('selected_theme') == 'theme_three')
                                        <a href="{{ route('user.select-car-purpose') }}" class="thm-btn">{{ __('LOGIN') }}</a>
                                    @endif
    ...
    <aside id="offcanvas-nav" >
        ...
        {{ Session::get('selected_theme') == 'theme_two' ? 'm-nav-two' : '' }} {{ Session::get('selected_theme') == 'theme_three' ? 'm-nav-three' : '' }} @endif ">
            ...
            <ul class="nav-links">
                <li class="dropdown">
                <a style="color: black" href="javascript:;">{{ __('translate.Home') }}
                     <span>
                ...
                <li><a style="color: black" href="{{ route('about-us') }}">{{ __('translate.About Us') }}</a></li>

                <li><a style="color: black" href="{{ route('listings') }}">{{ __('translate.Listings') }}</a></li>

                <li><a style="color: black" href="{{ route('dealers') }}">{{ __('translate.Dealers') }}</a></li>

                <li><a style="color: black" href="{{ route('blogs') }}">{{ __('translate.Blogs') }}</a></li>
                        ...
                        <div class="newsletter-sarch-box-main">
                            <form action="{{ route('newsletter-request') }}" class="newsletter-sarch-box" method="POST">
                                ...
                                <div class="newsletter-sarch-box-item">
                                    <input type="email" style="background-color: #2E326C" class="form-control" id="newsletter_email"
                                placeholder="{{ __('your@email.com') }}" name="email">
                                </div>
                                @if (Route::is('home'))
                            ...
                            <label class="form-label">
                                {{ __('SUBSCRIBE TO OUR NEWSLETTER') }}</label>
                        </div>
                ...
                <div class=" col-xl-4 col-lg-6 col-md-12 " data-aos="fade-right" data-aos-delay="100">
                    <div class="footer-logo">
                        <a href="{{ route('home') }}">
                            @if (Route::is('home'))
                                @if (Session::get('selected_theme') == 'theme_two')
                                    <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="padding-bottom: 2px">
                                @elseif (Session::get('selected_theme') == 'theme_three')
                                <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="padding-bottom: 2px">
                                @else
                                    <img src="{{ asset('japan_home/japan-logo.png') }}" alt="logo" style="padding-bottom: 2px">
                    ...
                    <div class="row footer-ml">
                        <div class="col-xl-4 col-lg-4 col-sm-6 col-md-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="footer-item-text">
                                <h3 style="color: #038ffc;">{{ __('Why Alpine') }}</h3>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 col-md-5 footer-res-mt " data-aos="fade-up"
                            data-aos-delay="300">
                            <div class="footer-item-text">
                                <h3 style="color: #038ffc;">{{ __('Quick Links') }}</h3>
                            </div>
                            <div class="footer-item-text-link">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <svg width="13" height="10" viewBox="0 0 13 10" fill="none"
                                                    ...
                                                    <path
                                                        d="M8.62856 9L12.2952 5M12.2952 5L8.62856 0.999999M12.2952 5L1.29523 5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                </svg></span> {{ __('Fixed Car Price Marketplace') }}
                                            </a>
                                        </li>
                                    <li>
                        ...
                        <div class="col-xl-4 col-lg-4   col-sm-6 col-md-3" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="footer-item-text-link two">
                                <div class="footer-item-text">
                                    <h3 style="color: #038ffc;">{{ __('Contact Info') }}</h3>
                                </div>
                            ...
                            <div class="footer-item-text-link two">
                                <div class="footer-item-text">
                                    <h3 style="color: #038ffc;font-size:20px;padding-top:40px">{{ __('We Accept credit Card') }}</h3>
                                </div>

                                <div class="footer-item-text">
                                    <img src="{{ asset('japan_home/group.svg') }}" alt="logo" style="padding-bottom:10px; height:60px">
                                </div>
