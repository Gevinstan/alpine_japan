                            ...
                            <div class="nav-btn pe-4">
                                <div class="menu">
                                    <ul class="nav nav_texthead">
                                                ...
                                                <div class="p-3">
                                                    <div class="row">
                                                        <div class="col-md-4 nav-dropdown-list">
                                                            ...
                                                            <div>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Toyota</a>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Nissan</a>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Honda</a>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Suzuki</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 nav-dropdown-list">
                                                            ...
                                                            <div>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Toyota</a>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Nissan</a>
                                                                <a class="dropdown-item nav-dropdown-item text-nowrap" href="{{ route('listings') }}">Mitsubishi</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 nav-dropdown-list">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('about-us') }}">Buy Now Cars</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('listings') }}">New Car Arrivals</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('dealers') }}">Useful Links</a>
                                        </li>
