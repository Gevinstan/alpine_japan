                                        ...
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                                ...
                                                <div class="brand-car-inner-item">
                                                    <span class="pt-3 text-truncate car-name ps-3" data-bs-toggle="tooltip" title="
        ...
        (function($) {
            ...
            if($("#vertical_brand").val()!=""){
                ...
                if(vertical_filter_model!=""){
                    ...
                    let newArrival = JSON.parse(localStorage.getItem('newArrival'));
                    ...
                    verticalChassis(newArrival,fuel_chassis[0])
                    verticalStartYear(newArrival,fuel_start_year[0],"vertical_start_year")
                    verticalStartYear(newArrival,fuel_end_year[0],"vertical_end_year")
                    verticalStartBudget(newArrival,fuel_start_budget[0],"vertical_budget_start")
                    verticalStartBudget(newArrival,fuel_end_budget[0],"vertical_budget_end")
                    verticalStartMileage(newArrival,fuel_start_mileage[0],"vertical_mileage_from")
                    verticalStartMileage(newArrival,fuel_end_mileage[0],"vertical_mileage_to")
                    verticalTransmission(newArrival,fuel_transmission[0])
                }    
                else {
                    if($("#vertical_brand").val()!=""){
                        for (let index = 0; index < model_list.length; index++) {
            ...
            let distinctData = JSON.parse(localStorage.getItem('newArrival'));
            $("#vertical_filter_model").on('change', function(e) {
                    ...
                    if($("#vertical_filter_model").val() !=""){
                            ...
                            success: function(data) {
                                localStorage.setItem('newArrival', JSON.stringify(data.response));
                            }
                            });
                    }  else {
                        localStorage.setItem('newArrival', JSON.stringify({}));
                    }
                    $('#search_form')[0].reset(); 
