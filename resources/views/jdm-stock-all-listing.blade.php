                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div style="margin-top: 15px; margin-bottom: 15px">
                                                                ...
                                                                <p style="display: inline;">Commission : <p style="font-size:18px; color: black; display: inline;"  id="commission_value"><b>${{isset($car->commission_value) ? $car->commission_value : '' }}</b></p></p>
