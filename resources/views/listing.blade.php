        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="car-specification" style="">
                        <div class="row">
                            <!-- <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px;" class="btn btn-outline-info btn-lg position-relative" type="button">Volvo</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 481px;top:156px" alt="delete" >
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px;" class="btn btn-outline-info btn-lg position-relative" type="button">$1lakh to $2lakh</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 650px;top:156px" alt="delete" >
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px;" class="btn btn-outline-info btn-lg position-relative" type="button">Diesel</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 817px;top:156px" alt="delete" >
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px;" class="btn btn-outline-info btn-lg position-relative" type="button">Sedan</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 988px;top:156px" alt="delete" >
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px;" class="btn btn-outline-info btn-lg position-relative" type="button">Automatic</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 1155px;top:157px" alt="delete" >
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="button">
                                   <button style="font-size:10px;color:black; margin-top:0px; margin-bottom:15px" class="btn btn-outline-info btn-lg position-relative" type="button">4 seater</button>
                                   <img src="{{  asset('japan_home/delete.png')  }}" class="position-absolute" style="left: 1320px;top:157px" alt="delete" >
                                </div>
                    ...
                    <div class="tab-content" id="pills-home-tab">
                                    ...
                                    <div class=" col-xxl-6  col-xl-12  col-lg-12  col-sm-12 ">
                                        <div class="brand-car-item">
                                            ...
                                            <div class="brand-car-inner">
                                                ...
                                                <a href="#">
                                                    <h3>{{ html_decode($car['model_name_en']) }}</h3>
                                                </a>
                                                ...
                                                <div class="brand-car-btm-txt-btm">
                                                    <h6 class="brand-car-btm-txt">{{ __('translate.Listed by') }} :</span> 
                                                    </h6>
...
$(document).ready(function() {
            ...
            let lastValue = $yearSlider.val();
            let previewTimeout;

            function updateYear(showPreview = false) {
                const year = 1960 + parseInt($yearSlider.val());
                if (showPreview) {
                    $previewYear.text(year).show();
                    $currentYear.hide();
                    clearTimeout(previewTimeout);
                    previewTimeout = setTimeout(() => {
                        $previewYear.hide();
                        $currentYear.text(year).show();
                    }, 1000);
                } else {
            ...
            function updateUrlWithYear(year) {
                ...
                // Update or set the year parameter
                params.set('year', year); // Sets the value of 'year' to the current slider value
                
                // Append the updated parameters to the current URL
