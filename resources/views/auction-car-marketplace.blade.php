                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample3">
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapsefour" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <span><p style="color: #038ffc;padding-left:10px; font-size:12px"><b>$0 $3,00,000</b></p></span>
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample5">
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapsesix" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                            <span><p style="color: #038ffc;padding-left:10px; font-size:12px" id="result_year"><b></b></p></span>
                                                <div class="range-container">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="brand-car-item">
                                            ...
                                            <div class="brand-car-inner">
                                                ...
                                                <a href="{{ route('auction_listing', $car['id']) }}">
                                                    <h3>
                                                    @if(session('front_lang')=='en')
...
endRange.addEventListener('input', () => {
    ...
    $(document).ready(function () {
        ...
        $("#start").on('input',function(e){
            $("#result_year").text(parseInt($(this).val()))
