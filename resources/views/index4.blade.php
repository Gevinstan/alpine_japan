                                    ...
                                    <div class="banner-slick-thumb-overlay">
                                        ...
                                        <div class="banner-slick-thumb-overlay-icon-main">
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                ...
                                                <h5 class="banner-slick-thumb-overlay-txt" >{{ html_decode($car['mileage_en']) }}</h5>
                                            </div>
                                            ...
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                <span class="banner-slick-thumb-overlay-icon" >
                                                                <svg width="20" height="20" viewBox="0 0 24 24" 
                                                                        ...
                                                                        <path
                                                                            d="M10.6667 8.66663H9.33333C9.14925 8.66663 9 8.81588 9 8.99996V10.3333C9 10.5174 9.14925 10.6666 9.33333 10.6666H10.6667C10.8507 10.6666 11 10.5174 11 10.3333V8.99996C11 8.81588 10.8507 8.66663 10.6667 8.66663ZM10.3333 9.99996H9.66667V9.33329H10.3333V9.99996Z" fill="#038FFC" stroke="#038FFC" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M14.0007 12H12.6673C12.4832 12 12.334 12.1493 12.334 12.3333V13.6667C12.334 13.8507 12.4832 14 12.6673 14H14.0007C14.1847 14 14.334 13.8507 14.334 13.6667V12.3333C14.334 12.1493 14.1847 12 14.0007 12ZM13.6673 13.3333H13.0007V12.6667H13.6673V13.3333Z" fill="#038FFC" stroke="#038FFC" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M14.0007 15.3334H12.6673C12.4832 15.3334 12.334 15.4826 12.334 15.6667V17C12.334 17.1841 12.4832 17.3334 12.6673 17.3334H14.0007C14.1847 17.3334 14.334 17.1841 14.334 17V15.6667C14.334 15.4826 14.1847 15.3334 14.0007 15.3334ZM13.6673 16.6667H13.0007V16H13.6673V16.6667Z" fill="#038FFC" stroke="#038FFC" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M14.0007 8.66663H12.6673C12.4832 8.66663 12.334 8.81588 12.334 8.99996V10.3333C12.334 10.5174 12.4832 10.6666 12.6673 10.6666H14.0007C14.1847 10.6666 14.334 10.5174 14.334 10.3333V8.99996C14.334 8.81588 14.1847 8.66663 14.0007 8.66663ZM13.6673 9.99996H13.0007V9.33329H13.6673V9.99996Z" fill="#038FFC" stroke="#038FFC" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M4.00065 8.66663H2.66732C2.48324 8.66663 2.33398 8.81588 2.33398 8.99996V10.3333C2.33398 10.5174 2.48324 10.6666 2.66732 10.6666H4.00065C4.18473 10.6666 4.33398 10.5174 4.33398 10.3333V8.99996C4.33398 8.81588 4.18473 8.66663 4.00065 8.66663ZM3.66732 9.99996H3.00065V9.33329H3.66732V9.99996Z" fill="#038FFC" stroke="#038FFC" stroke-width="0.2"/>
                                                                </svg>                
                                                </span>
                                                <h5 class="banner-slick-thumb-overlay-txt">{{ html_decode($car['year_en']) }}</h5>
                                            </div>
                                            ...
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                ...
                                                <h5 class="banner-slick-thumb-overlay-txt">{{ html_decode($car['transmission_en']) }}</h5>
                                            </div>
                                        </div>
                                    </div>      
                                </div>
