        ...
        <div class="container">
                ...
                <div class="col-lg-6 col-sm-6  col-md-6">
                    <div class="taitel">
                        ...
                        <!-- <span>{{ __('translate.verified Available Brand Car') }}</span> -->
                            ...
                            <h2 style="display: inline;">{{__('translate.JDM')}}</h2> 
                            <h2 style="display: inline; color: #038ffc;">{{__('translate.Cars')}}</h2>
                </div>
            ...
            <div class="row mt-60px">
                <div class="col-lg-12">
                    ...
                    <div class="brand-car-btn mt-48px">
                        <a href="{{ route('jdm-stock-all') }}" class="thm-btn">{{ __('SEE ALL') }}</a>
                    </div>
                </div>
            </div>    
        </div>
