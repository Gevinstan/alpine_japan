            ...
            <div class="container">
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6 col-sm-6  col-md-6">
                        <h2 class="section-heading">Top Selling<span class="highlight"> Cars<span></h2>
                    </div>
                </div>
            ...
            <div class="buy-container">
                ...
                <div class="row d-flex justify-content-center px-5 gap-5">
                    <div class="col-md-3">
                        <div class="step-circle">
                            <div class="inner-card">
                                <img src="{{asset('japan_home/car_search.png')}}" alt="search"/>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 my-sm-4 my-md-0">
                        <div class="step-circle">
                            <div class="inner-card">
                                <img src="{{asset('japan_home/file.png')}}" alt="search"/>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="step-circle">
                            <div class="inner-card">
                                <img src="{{asset('japan_home/dollar.png')}}" alt="search"/>
                            </div>
                        </div>
