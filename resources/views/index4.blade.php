                                    ...
                                    <div class="banner-slick-thumb-overlay">
                                        ...
                                        <div class="banner-slick-thumb-overlay-icon-main">
                                            ...
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                ...
                                                <h5 class="banner-slick-thumb-overlay-txt" ></h5>
                                            </div>
                                            <div class="banner-slick-thumb-overlay-icon-main-item">
                                                <span class="banner-slick-thumb-overlay-icon" >
        ...
        <div class="container">
            ...
            <div class="row align-items-end">
                <div class="col-lg-6 col-sm-6  col-md-6">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-6 col-sm-6  col-md-6">
                            <h2 class="section-heading">JDM<span class="highlight"> Cars<span></h2>
                        </div>
                    </div>        
                </div>
                                        ...
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                                ...
                                                <div class="w-100 brand-new-car">
                                                    <img src="{{ asset('Cars/' . $car->image) }}" alt="logo" class="cars_image">
                                                </div>
                                            ...
                                            <div class="brand-car-inner">
                                                <div class="brand-car-inner-item">
                                                    <span class="fw-bolder px-2 py-1">
                                                ...
                                                <a href="#" data-bs-toggle="tooltip" title="Skyline">
                                                    <h3 class="text-truncate px-2">
                                                    @if(session('front_lang')=='en')
                                                                {{ $car->model }}
                                                            @else
                                                            {{ $car->model }}
                            ...
                            <div class="col-lg-4">
                                <div class="brand-car-item">
                                    <div class="brand-car-item-img">
                                     ...
                                     <div class="w-100 brand-new-car">
                                        <img src="{{ asset($car['picture']) }}" alt="thumb" class="cars_image">
                                    </div>
                                    ...
                                    <div class="brand-car-inner">
                                        ...
                                        <a href="{{ route('listing', $car['id']) }}" data-bs-toggle="tooltip" title="N BOX">
