            ...
            <div class="row">
                <div class="col-md-12 shipment-img">
                    ...
                    <div class="shipment-top-left">
                        <p class="shipment-top-left-p" >Shipment</p>
                    </div>

                    <div class="shipment-bottom-left">
                        <p class="shipment-bottom-left-p"><b>We are very flexible by offering various different modes of</b></p><br>
                        <p class="shipment-bottom-left-p"><b>shipments as shown below. After all Customer</b></p><br>
                        <p class="shipment-bottom-left-p"><b>Satisfaction is our Top Interest.</b></p><br>
                    </div>
        ...
        <div class="shipment-card ">
            <span class="shipment-bod gap-5">
                ...
                <div class="d-flex justify-content-center ">
                    <button class="btn btn-primary car-buy w-38" type="button">MAKING CAR BUYING SIMPLE-CLICK HERE</button>
                </div>
            </span>
        </div>
    </section>
        ...
        <div class="container roro-center my-5">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-12">
                    ...
                    <h6 class="mt-3 mx-5">Each unit is driven straight into the Vessel carefully, all units are shipped under deck so that you receive 
                        the units in immaculate condition just as described at the time of purchase. We have a tie up with all major 
                        liners operating from Japan at very special Ocean freight rates and shortest sailing time upto your port of 
                        destination.
                    </h6>
                </div>
        ...
        <div class="container cont-center my-5">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-12">
                    ...
                    <h6 class="mt-3 mx-5">We understand that Freight Cost saving plays a major role in any business, 
                        ...
                        into the container with utmost care and will be shipped promptly to any desired port Worldwide.
                    </h6>
                </div>

                <div class="col-md-12 col-sm-12 col-lg-12 cont-img mt-3 gap-3">
            ...
            <div class="container-fluid insp-center pb-5">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        ...
                        <h6 class="mt-3 mx-5">Every country has different quality compliance procedures, Our operation team 
                            take care of that by arranging suitable third party inspection for each country by meeting all 
