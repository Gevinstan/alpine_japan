        ...
        <div class="container px-2 px-sm-3 px-lg-5">
            <nav aria-label="breadcrumb" class="">
                <ol class="breadcrumb breadcrumb-list px-3">
                    ...
                    <li class="breadcrumb-item breadcrumb-link" aria-current="page">{{ __('translate.Top Selling Listing') }}</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-lg-3">
                                        ...
                                        <div class="brand-car-item">
                                            ...
                                            <div class="">
                                                <div class="pt-2">
                                                    ...
                                                    <div class="text-truncate_list2 car-fullname ps-1" data-bs-toggle="tooltip" 
                                                        title=" @if(session('front_lang')=='en')
                                                            {{ html_decode($car['model_name_en']) }}
                                                        @else
                                                            {{ html_decode($car['model_name']) }}
