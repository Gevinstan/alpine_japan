                                ...
                                <div class="inventory-sarch-ber px-1">
                                    ...
                                    <input type="text" class="form-control" id="outside_form_search" name="search"
                                     ...
                                     <span class="search-btn" style="cursor: pointer;">
                                        <a href="javascript:void(0);" id="outside_form_btn"><i class="bi bi-search"></i></a>
                                    </span>
                                </div>
                                    ...
                                    <div class="col-lg-4  col-sm-6 col-md-6" data-aos="fade-up"
                                        ...
                                        <div class="brand-car-item">
                                            ...
                                            <div class="brand-car-inner position-relative">
                                                ...
                                                <a href="{{ route('car_listing_details', $car['id']) }}"data-bs-toggle="tooltip" title="{{ html_decode($car['model_name_en']) }}">
