                                                    ...
                                                    @foreach ($brands as $index=> $brand)
                                                            ...
                                                            <div class="accordion-item">
                                                                <span class="form-check d-flex flex-column align-items-start list-dropdown" id="headingOne">
                                                                    <div class="gap-2 brand_model accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{$index}}" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <!-- Select Your Budget  -->
                                <!-- <div class="accordion" id="accordionPanelsStayOpenExample1">
                                    <div class="accordion-item ps-3">
                                        ...
                                        <div id="panelsStayOpen-collapsetwo" class="pt-3 accordion-collapse collapse"
                                            aria-labelledby="panelsStayOpen-headingtwo">
                                            <div class="accordion-body">
                                                <span class="p-0 border-0 select-Brand-box two four">
                                                    <div class="gap-3 m-0 slider-container d-flex align-items-center">
                        ...
                        @foreach(request('brand') as $index => $brandSlug)
                            <!-- <p class="px-3 py-1 position-relative filter-text">
                                <span class="brand-item" data-brand="{{ $brandSlug }}">{{ $brandSlug }}
                                        <span class="top-0 position-absolute start-100 translate-middle rounded-circle">
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-md-6" data-aos="fade-u p"
                                        ...
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                                <div class="">
                                                <a href="{{ route('fixed-car-marketplace-details', ['category' => 'fixed-car-marketplace', 'id' => $car['id']]) }}" class="text-truncate_list2">
                                            ...
                                            <div class="brand-car-inner position-relative">
                                                ...
                                                <a href="{{ route('fixed-car-marketplace-details', ['category' => 'top-selling', 'id' => $car['id']]) }}"data-bs-toggle="tooltip" title="FORWARD">
                            ...
                            <div class="row g-5 brand-car-two">
                                @forelse ($cars_array as $index => $car)
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-sm-6">
                                        <div class="brand-car-item">
                                            <div class="brand-car-item-img">
                                            <a href="{{ route('fixed-car-marketplace-details',['category' => 'fixed-car-marketplace-details', 'id' => $car['id']]) }}" class="text-truncate_list2">
                                                 <img src="{{asset($car['picture']) }}" alt="thumb" class="card_image">
                                            </a>     
                                            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="text-truncate_list2 ps-1" data-bs-toggle="tooltip" 
                                                        title="@if(session('front_lang')=='en')
                                                            ...
                                                            @endif  
                                                        ">
                                                        <a href="{{ route('fixed-car-marketplace-details', ['category' => 'top-selling', 'id' => $car['id']]) }}" class="text-truncate_list2">
        ...
        (function($) {
            ...
            if($("#vertical_brand").val()!=""){
                ...
                if(vertical_filter_model!=""){
                    ...
                    let topSelling = JSON.parse(localStorage.getItem('topSelling'));
                    ...
                    verticalChassis(topSelling,fuel_chassis[0])
                    verticalStartYear(topSelling,fuel_start_year[0],"vertical_start_year")
                    verticalStartYear(topSelling,fuel_end_year[0],"vertical_end_year")
                    verticalStartBudget(topSelling,fuel_start_budget[0],"vertical_budget_start")
                    verticalStartBudget(topSelling,fuel_end_budget[0],"vertical_budget_end")
                    verticalStartMileage(topSelling,fuel_start_mileage[0],"vertical_mileage_from")
                    verticalStartMileage(topSelling,fuel_end_mileage[0],"vertical_mileage_to")
                    verticalTransmission(topSelling,fuel_transmission[0])
                }    
                else {
                    if($("#vertical_brand").val()!=""){
                        for (let index = 0; index < model_list.length; index++) {
             ...
             $('#vertical_brand').on('change',function(e){
                e.preventDefault();  
                localStorage.removeItem('topSelling');
            ...
            let distinctData = JSON.parse(localStorage.getItem('topSelling'));
            $("#vertical_filter_model").on('change', function(e) {
                    ...
                    if($("#vertical_filter_model").val() !=""){
                            ...
                            datatype: 'JSON',
                            url: '{{ route("search.filter.new-arrial") }}',
                            success: function(data) {
                                localStorage.setItem('topSelling', JSON.stringify(data.response));
                            }
                            });
                    }  else {
                        localStorage.setItem('topSelling', JSON.stringify({}));
                    }
                    $('#search_form')[0].reset(); 
