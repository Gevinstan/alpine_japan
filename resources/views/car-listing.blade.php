                        ...
                        <div class="inventory-ber-right">
                            <div class="inventory-ber-right-btn">
                                <ul class="nav nav-pills " id="pills-tab" role="tablist">
                                    ...
                                    <input type="hidden" name="view" id='list_view_id'>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div class="brand-car-inner-item-thumb">
                                                            <span class="icon-card1">
                                                                <svg width="24" height="24" viewBox="0 0 24 24" 
                                                                        ...
                                                                        <path
                                                                            d="M7.33268 11.9999H5.99935C5.81527 11.9999 5.66602 12.1492 5.66602 12.3333V13.6666C5.66602 13.8507 5.81527 13.9999 5.99935 13.9999H7.33268C7.51676 13.9999 7.66602 13.8507 7.66602 13.6666V12.3333C7.66602 12.1492 7.51676 11.9999 7.33268 11.9999ZM6.99935 13.3333H6.33268V12.6666H6.99935V13.3333Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M10.6667 12H9.33333C9.14925 12 9 12.1493 9 12.3333V13.6667C9 13.8507 9.14925 14 9.33333 14H10.6667C10.8507 14 11 13.8507 11 13.6667V12.3333C11 12.1493 10.8507 12 10.6667 12ZM10.3333 13.3333H9.66667V12.6667H10.3333V13.3333Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M4.00065 12H2.66732C2.48324 12 2.33398 12.1493 2.33398 12.3333V13.6667C2.33398 13.8507 2.48324 14 2.66732 14H4.00065C4.18473 14 4.33398 13.8507 4.33398 13.6667V12.3333C4.33398 12.1493 4.18473 12 4.00065 12ZM3.66732 13.3333H3.00065V12.6667H3.66732V13.3333Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M7.33268 15.3334H5.99935C5.81527 15.3334 5.66602 15.4826 5.66602 15.6667V17C5.66602 17.1841 5.81527 17.3334 5.99935 17.3334H7.33268C7.51676 17.3334 7.66602 17.1841 7.66602 17V15.6667C7.66602 15.4826 7.51676 15.3334 7.33268 15.3334ZM6.99935 16.6667H6.33268V16H6.99935V16.6667Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M10.6667 15.3334H9.33333C9.14925 15.3334 9 15.4826 9 15.6667V17C9 17.1841 9.14925 17.3334 9.33333 17.3334H10.6667C10.8507 17.3334 11 17.1841 11 17V15.6667C11 15.4826 10.8507 15.3334 10.6667 15.3334ZM10.3333 16.6667H9.66667V16H10.3333V16.6667Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M4.00065 15.3334H2.66732C2.48324 15.3334 2.33398 15.4826 2.33398 15.6667V17C2.33398 17.1841 2.48324 17.3334 2.66732 17.3334H4.00065C4.18473 17.3334 4.33398 17.1841 4.33398 17V15.6667C4.33398 15.4826 4.18473 15.3334 4.00065 15.3334ZM3.66732 16.6667H3.00065V16H3.66732V16.6667Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M7.33268 8.66669H5.99935C5.81527 8.66669 5.66602 8.81594 5.66602 9.00002V10.3334C5.66602 10.5174 5.81527 10.6667 5.99935 10.6667H7.33268C7.51676 10.6667 7.66602 10.5174 7.66602 10.3334V9.00002C7.66602 8.81594 7.51676 8.66669 7.33268 8.66669ZM6.99935 10H6.33268V9.33335H6.99935V10Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M10.6667 8.66663H9.33333C9.14925 8.66663 9 8.81588 9 8.99996V10.3333C9 10.5174 9.14925 10.6666 9.33333 10.6666H10.6667C10.8507 10.6666 11 10.5174 11 10.3333V8.99996C11 8.81588 10.8507 8.66663 10.6667 8.66663ZM10.3333 9.99996H9.66667V9.33329H10.3333V9.99996Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M14.0007 12H12.6673C12.4832 12 12.334 12.1493 12.334 12.3333V13.6667C12.334 13.8507 12.4832 14 12.6673 14H14.0007C14.1847 14 14.334 13.8507 14.334 13.6667V12.3333C14.334 12.1493 14.1847 12 14.0007 12ZM13.6673 13.3333H13.0007V12.6667H13.6673V13.3333Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
                                                                            d="M14.0007 15.3334H12.6673C12.4832 15.3334 12.334 15.4826 12.334 15.6667V17C12.334 17.1841 12.4832 17.3334 12.6673 17.3334H14.0007C14.1847 17.3334 14.334 17.1841 14.334 17V15.6667C14.334 15.4826 14.1847 15.3334 14.0007 15.3334ZM13.6673 16.6667H13.0007V16H13.6673V16.6667Z" fill="#0D274E" stroke="#0D274E" stroke-width="0.2"/>
                                                                        <path
...
@push('js_section')
    ...
    <script>
        ...
        (function($) {
            ...
            //     if (viewParam) {
            //         $(`.listing-view[data-view="${viewParam}"]`).addClass('active');
            //     } else {
            //         // Optionally set a default view
            //         $('.listing-view').first().addClass('active');
            //     }
            ...
            //     document.querySelectorAll('.listing-view').forEach(el => el.classList.remove('active'));

            //     if (viewParam) {
                
            //         // Activate the button with the matching data-view
            //         let activeButton = document.querySelector(`.listing-view[data-view="${viewParam}"]`);
            //         if (activeButton) {
                       
            //             // activeButton.classList.add('active');
            //             activeButton.click(); // Ensure the UI changes or any event is triggered
            //         }
            //     } else {
                    
            //         // Default to the first button if no viewParam
            //         let defaultButton = document.querySelector('.listing-view[data-view="list"]');
            //         if (defaultButton) {
        ...
        //         $("#list_view_id").val($(this).data('view'));
        ...
        //    })
            ...
            document.getElementById('show-more-filters')?.addEventListener('click', function() {
                fetch('{{ route("load.more.filters") }}?show_all=true', {
                    headers: {
    ...
    document.addEventListener('DOMContentLoaded', function () {
            // Attach event listeners to all close buttonsmodel
