...
@section('body-header') 
    ...
    <p class="crancy-header__text">{{ __('translate.Small Heavy') }} >> {{ __('translate.Edit Small Heavy') }}</p>
    <style>
         .file_image{
                                            ...
                                            <div class="row mg-top-30">
                                                ...
                                                <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="model" id="model" value="{{$smallHeavy->model}}">
                                                        @error('model')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="remarks" id="remarks" class='crancy__item-input'>{{$smallHeavy->remarks}}</textarea>
                                                        @error('remarks')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="sell_points" id="sell_points" class='crancy__item-input'>{{$smallHeavy->sell_points}}</textarea>
                                                        @error('sell_points')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
