...
@section('title')
    <title>{{ __('translate.Add Small Heavy') }}</title>
@endsection

@section('body-header') 
    <h3 class="crancy-header__title m-0">{{ __('translate.Add Small Heavy') }}</h3>
    <a href="{{route('admin.dashboard')}}"><p class="crancy-header__text">{{ __('translate.Small Heavy') }} >> {{ __('translate.Add Small Heavy') }}</p></a>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.small-heavy.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Add Small Heavy') }}</h4>
