...
@section('body-header') 
    ...
    <p class="crancy-header__text">{{ __('translate.Car') }} >> {{ __('translate.Edit Car') }}</p>
    <style>
         .file_image{
                                                    ...
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <select  name="brand" id="brand"  class="crancy__item-input">
                                                           ...
                                                           @foreach($brands as $brand)
                                                              <option value="{{$brand->id}}" {{$brand->slug == $cars->brand ? 'selected' : ''}}>{{$brand->slug}}</option>
                                                           @endforeach  
                                                        </select>
                                                        @error('maker')
                                                            <div style="color: red;">{{ $message }}</div>
                                            ...
                                            <div class="row mg-top-30">                                  
                                                ...
                                                <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="remarks" id="remarks" class='crancy__item-input'>{{$cars->remarks}}</textarea>
                                                        @error('remarks')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <textarea name="sell_points" id="sell_points" class='crancy__item-input'>{{$cars->sell_points}}</textarea>
                                                        @error('sell_points')
                                                            <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
