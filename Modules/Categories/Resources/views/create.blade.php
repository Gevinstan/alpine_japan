...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Categories') }} >> {{ __('translate.Create Categories') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Create Categories') }}</h4>
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        <label class="crancy__item-label">{{ __('translate.Name') }} * </label>
                                                            <input type="text" class="crancy__item-input" name="name" id="name">
                                                            @error('name')
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="average_price" id="average_price">
                                                        @error('average_price')
                                                                <div style="color: red;">{{ $message }}</div>
                                                        @enderror
                                                    </div>
