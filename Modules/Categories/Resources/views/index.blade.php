...
@section('title')
    <title>{{ __('translate.Categories List') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Categories List') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Categories') }} >> {{ __('translate.Categories List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box d-flex  justify-between">
                                            <h4 class="crancy-product-card__title">{{ __('translate.Categories List') }}</h4>
                                           <div class="d-flex gap-3">
                                            <a href="{{ route('admin.categories.create') }}" class="crancy-btn text-nowrap"><span>
                                            ...
                                            @foreach ($categories as $index => $categories)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                         <input type="checkbox" name="" id="" data-id="{{$categories->id}}" class="form-control td-checkbox-class">
                                                    </td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $categories->name }}</h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $categories->price }}</h4>
                                                    </td>
