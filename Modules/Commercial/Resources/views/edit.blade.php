...
@section('body-header') 
    ...
    <a href="{{route('admin.dashboard')}}"><p class="crancy-header__text">{{ __('translate.Commercial') }} >> {{ __('translate.Edit Commercial') }}</p></a>
    <style>
         .file_image{
                                                    ...
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        ...
                                                        <select  name="brand" id="brand"  class="crancy__item-input">
                                                           ...
                                                           @foreach($brands as $brand)
                                                              <option value="{{$brand->id}}" {{$brand->slug == $commercial->make ? 'selected' : ''}}>{{$brand->slug}}</option>
                                                           @endforeach  
                                                        </select>
                                                        @error('maker')
                                                            <div style="color: red;">{{ $message }}</div>
