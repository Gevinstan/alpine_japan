...
@section('title')
    <title>{{ __('translate.Heavy Stock List') }}</title>
@endsection
                                ...
                                <div id="crancy-table__main_wrapper" class="no-footer">
                                    ...
                                    <table class="crancy-table__main-v3 no-footer" id="dataTable">
                                        ...
                                        <tbody class="crancy-table__body">
                                           @foreach ($heavies as $index => $commerical)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <img src="{{ asset('Heavy/' .$commercial->id.'/'. $commerical->image) }}"  width="100" height="100" alt="Product Image" class="common-image">
                                                    </td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <a href="{{ route('admin.heavy.edit', ['heavy' => $commerical->id] ) }}" style="color:grey;" title="Edit"><i class="fas fa-edit"></i></a>
                                                        <a onclick="itemDeleteConfrimation({{ $commerical->id }})" href="javascript:;" data-bs-toggle="modal" title="Delete" data-bs-target="#exampleModal"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach 
...
@push('js_section')
    ...
    $("#comissionBtn").on('click', function() {
        ...
        topSellButtons.forEach(function(topSellButton) {
                ...
                $.ajax({
                    url: "{{ route('admin.new-arrival-cars') }}",
                    type: "POST",
